...
LOCAL_IMAGE_NAME=ytcheng/desktop-connector-dev
REMOTE_IMAGE_NAME=ytcheng/desktop-connector
...
install-extension: extension ## Install extension image Docker desktop
	docker extension install $(LOCAL_IMAGE_NAME)
.PHONY: install-extension

update-extension: extension ## Install extension image Docker desktop
	docker extension update $(LOCAL_IMAGE_NAME)
.PHONY: update-extension

dev-extension: update-extension
	@docker extension dev debug $(LOCAL_IMAGE_NAME)
	@docker extension dev ui-source $(LOCAL_IMAGE_NAME) http://localhost:3000
